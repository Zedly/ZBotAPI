...
public enum EntityType {
     ...
     */
    ENDER_PEARL("ender_pearl", ThrownEnderPearl.class, 14),
    /**
     * An ender eye signal.
     */
     ...
     * @see EvokerFangs
     */
    EVOKER_FANGS("evoker_fangs", EvocationFangs.class, 33),
    /**
     * @see Evoker
     */
     ...
     */
    MINECART("minecart", MinecartRideable.class, 42),
    /**
     * @see StorageMinecart
     */
